...
\caption{\label{tab:lagrange} In giallo soluzione trovata dal solutore nel limite dei 300 secondi. In rosso il nuovo gap calcolato utilizzando come nuovo lowerbound la soluzione del problema lagrangeano all'interno della funzione obiettivo del problema originale}
\end{table}
